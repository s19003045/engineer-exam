...
title: "原型鍊查找流程"
level: ["Junior"]
tags: ["JavaScript", "fundamentals", "prototype"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "coding"
interview_type: "coding"
estimated_time: 15
objective: "以 JavaScript 完成「原型鍊查找流程」的可執行解法，並說明複雜度與邊界。"
...
starter_code: "function solve(input) {\n  // TODO: implement for 原型鍊查找流程\n  return null;\n}"
version: 1
status: active
---

## 背景情境
你正在面試情境中處理「原型鍊查找流程」相關任務。請先明確問題邊界與假設，不要直接給結論。
