---
id: q-js-13
title: "Set/WeakSet 實際場景"
level: ["Junior"]
tags: ["JavaScript", "memory", "collection"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "triage"
interview_type: "triage"
estimated_time: 15
objective: "針對「Set/WeakSet 實際場景」進行問題定位、優先級排序與處置決策。"
...
## 背景情境
你正在面試情境中處理「Set/WeakSet 實際場景」相關任務。請先明確問題邊界與假設，不要直接給結論。
