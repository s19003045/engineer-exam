---
id: q-js-15
title: "Fetch API 錯誤重試策略"
level: ["Junior"]
tags: ["JavaScript", "network", "resilience"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "design"
interview_type: "design"
estimated_time: 15
objective: "針對「Fetch API 錯誤重試策略」提出可落地方案，說明取捨與風險。"
...
## 背景情境
你正在面試情境中處理「Fetch API 錯誤重試策略」相關任務。請先明確問題邊界與假設，不要直接給結論。
