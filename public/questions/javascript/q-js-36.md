---
id: q-js-36
title: "測試題：mock fetch 與 timeout"
level: ["Senior"]
tags: ["JavaScript", "testing", "mocking"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "coding"
interview_type: "coding"
estimated_time: 25
objective: "以 JavaScript 完成「測試題：mock fetch 與 timeout」的可執行解法，並說明複雜度與邊界。"
...
starter_code: "function solve(input) {\n  // TODO: implement for 測試題：mock fetch 與 timeout\n  return null;\n}"
version: 1
status: active
---

## 背景情境
你正在面試情境中處理「測試題：mock fetch 與 timeout」相關任務。請先明確問題邊界與假設，不要直接給結論。
