---
id: q-js-50
title: "AI 協作題：接受/拒絕 AI 建議"
level: ["Lead"]
tags: ["JavaScript", "ai-collaboration", "decision"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "triage"
interview_type: "triage"
estimated_time: 35
objective: "針對「AI 協作題：接受/拒絕 AI 建議」進行問題定位、優先級排序與處置決策。"
...
## 背景情境
你正在面試情境中處理「AI 協作題：接受/拒絕 AI 建議」相關任務。請先明確問題邊界與假設，不要直接給結論。
