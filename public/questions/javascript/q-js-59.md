---
id: q-js-59
title: "Web Worker 分工設計"
level: ["Senior"]
tags: ["JavaScript", "worker", "performance"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "design"
interview_type: "design"
estimated_time: 25
objective: "針對「Web Worker 分工設計」提出可落地方案，說明取捨與風險。"
...
## 背景情境
你正在面試情境中處理「Web Worker 分工設計」相關任務。請先明確問題邊界與假設，不要直接給結論。
