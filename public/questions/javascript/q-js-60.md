---
id: q-js-60
title: "Service Worker 快取策略"
level: ["Senior"]
tags: ["JavaScript", "pwa", "cache"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "design"
interview_type: "design"
estimated_time: 25
objective: "針對「Service Worker 快取策略」提出可落地方案，說明取捨與風險。"
...
## 背景情境
你正在面試情境中處理「Service Worker 快取策略」相關任務。請先明確問題邊界與假設，不要直接給結論。
