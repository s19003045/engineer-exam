---
id: q-js-61
title: "IndexedDB 離線資料設計"
level: ["Senior"]
tags: ["JavaScript", "indexeddb", "offline"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "design"
interview_type: "design"
estimated_time: 25
objective: "針對「IndexedDB 離線資料設計」提出可落地方案，說明取捨與風險。"
...
## 背景情境
你正在面試情境中處理「IndexedDB 離線資料設計」相關任務。請先明確問題邊界與假設，不要直接給結論。
