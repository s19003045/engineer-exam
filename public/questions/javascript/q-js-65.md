---
id: q-js-65
title: "requestAnimationFrame 優化"
level: ["Senior"]
...
estimated_time: 25
objective: "以 JavaScript 完成「requestAnimationFrame 優化」的可執行解法，並說明複雜度與邊界。"
...
starter_code: "function solve(input) {\n  // TODO: implement for requestAnimationFrame 優化\n  return null;\n}"
version: 1
status: active
---

## 背景情境
你正在面試情境中處理「requestAnimationFrame 優化」相關任務。請先明確問題邊界與假設，不要直接給結論。
