---
id: q-js-66
title: "Reflow/Repaint 問題排查"
level: ["Senior"]
tags: ["JavaScript", "rendering", "performance"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "triage"
interview_type: "triage"
estimated_time: 25
objective: "針對「Reflow/Repaint 問題排查」進行問題定位、優先級排序與處置決策。"
...
## 背景情境
你正在面試情境中處理「Reflow/Repaint 問題排查」相關任務。請先明確問題邊界與假設，不要直接給結論。
