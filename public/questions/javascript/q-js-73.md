---
id: q-js-73
title: "Web Accessibility 基礎檢查"
level: ["Junior"]
tags: ["JavaScript", "a11y", "ui"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "triage"
interview_type: "review"
estimated_time: 15
objective: "針對「Web Accessibility 基礎檢查」進行問題定位、優先級排序與處置決策。"
...
## 背景情境
你正在面試情境中處理「Web Accessibility 基礎檢查」相關任務。請先明確問題邊界與假設，不要直接給結論。
