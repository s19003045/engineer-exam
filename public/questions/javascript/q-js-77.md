---
id: q-js-77
title: "快取失效策略(Cache Invalidation)"
level: ["Lead"]
tags: ["JavaScript", "cache", "architecture"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "design"
interview_type: "design"
estimated_time: 35
objective: "針對「快取失效策略(Cache Invalidation)」提出可落地方案，說明取捨與風險。"
...
## 背景情境
你正在面試情境中處理「快取失效策略(Cache Invalidation)」相關任務。請先明確問題邊界與假設，不要直接給結論。
