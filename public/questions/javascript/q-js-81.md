---
id: q-js-81
title: "WebSocket 斷線重連設計"
level: ["Senior"]
tags: ["JavaScript", "websocket", "resilience"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "coding"
interview_type: "coding"
estimated_time: 25
objective: "以 JavaScript 完成「WebSocket 斷線重連設計」的可執行解法，並說明複雜度與邊界。"
...
starter_code: "function solve(input) {\n  // TODO: implement for WebSocket 斷線重連設計\n  return null;\n}"
version: 1
status: active
---

## 背景情境
你正在面試情境中處理「WebSocket 斷線重連設計」相關任務。請先明確問題邊界與假設，不要直接給結論。
