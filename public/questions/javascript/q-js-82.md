---
id: q-js-82
title: "SSE 與 WebSocket 取捨"
level: ["Senior"]
tags: ["JavaScript", "realtime", "architecture"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "design"
interview_type: "design"
estimated_time: 25
objective: "針對「SSE 與 WebSocket 取捨」提出可落地方案，說明取捨與風險。"
...
## 背景情境
你正在面試情境中處理「SSE 與 WebSocket 取捨」相關任務。請先明確問題邊界與假設，不要直接給結論。
