---
id: q-js-99
title: "AI 協作：程式碼審查提示詞"
level: ["Lead"]
tags: ["JavaScript", "ai-collaboration", "prompt"]
template_group: ["JavaScript-Core", "Interview-Mixed"]
question_type: "triage"
interview_type: "review"
estimated_time: 35
objective: "針對「AI 協作：程式碼審查提示詞」進行問題定位、優先級排序與處置決策。"
...
## 背景情境
你正在面試情境中處理「AI 協作：程式碼審查提示詞」相關任務。請先明確問題邊界與假設，不要直接給結論。
